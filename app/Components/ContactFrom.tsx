        ...
        <div className="md:flex gap-x-24 clear-left md:mb-16 mb-10">
          ...
          <div className="border-l-2 md:border-indigo-600 border-white px-10 py-6">
            ...
            <div className="mb-4">
              ...
              <PhoneLink phone="+66022867561" />
            </div>
            <div className="mb-4">
              <h6 className="text-gray-500 text-sm font-medium leading-5 pb-3 md:text-start flex text-center">
                Head Office
              </h6>
              <p>127 Panjabhum Building 2 12th floor, S Sathon Rd, Thung Maha Mek, Sathon, Bangkok 10120, Thailand</p>
            </div>
            <div >
              <h6 className="text-gray-500 text-sm font-medium leading-5 pb-3 md:text-start flex text-center">
                Follow Us
              ...
              <div className="flex -mx-1.5">
                <a className="mx-1.5 dark:hover:text-red-400 text-gray-400 transition-colors duration-300 transform hover:text-red-500" href="https://www.youtube.com/@axgroupofficial" target="_blank">
                ...
                <a className="mx-1.5 dark:hover:text-red-400 text-gray-400 transition-colors duration-300 transform hover:text-red-500" href="https://www.linkedin.com/in/AX%20Group" target="_blank">
                ...
                <a className="mx-1.5 dark:hover:text-red-400 text-gray-400 transition-colors duration-300 transform hover:text-red-500" href="https://www.facebook.com/axgroupofficial" target="_blank">
                  <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <a className="mx-1.5 dark:hover:text-red-400 text-gray-400 transition-colors duration-300 transform hover:text-red-500" href="https://www.instagram.com/axgroup_official" target="_blank">
